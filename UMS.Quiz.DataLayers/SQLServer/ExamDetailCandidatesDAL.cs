...
namespace UMS.Quiz.DataLayers.SQLServer
{
    public class ExamDetailCandidatesDAL:_BaseDAL, ICommonDAL<ExamDetailCandidates>
    {
        ...
        public ExamDetailCandidates? Get(string id)
        {
            throw new NotImplementedException();
        }
        ...
        public IList<ExamDetailCandidates> List(int page = 1, int pageSize = 0, string searchValue = "", string termId = "", int AccountId = 0)
        {
            throw new NotImplementedException();
        }
